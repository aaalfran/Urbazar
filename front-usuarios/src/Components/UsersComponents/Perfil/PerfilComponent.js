...
function PerfilComponent(props) {
  ...
  useEffect(() => {
    const getProducts = async () => {
      try {
        const response = await axios.get(`${data.url}/productos`)
        ...
        <div className="emp-profile">
          ...
          >
            <Fade in={open}>
              <div
                className={
                  classes.paper + ' rounded w-75 mx-auto my-3 modalResponsive'
                }
              >
                <h2 id="transition-modal-title">Modo Vendedor</h2>
                <p id="transition-modal-description">
                  ¿Quieres activar las funcionalidades de un vendedor?
                </p>
                <VendedorCompra
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="profile-head">
                  <h3>¡Bienvenido {info.nombre}!</h3>
                  <h6>
                    {info.vendedorTipo !== null
                      ? (
                      <FormControlLabel
                        control={
                          <Switch name="modo_vendedor" checked={switchV} />
                        }
                        label="Modo vendedor"
                        onClick={(e) => {
                          setSwitchV(!switchV)
                ...
                <div className="tab-content profile-tab" id="myTabContent">
                  ...
                  >
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <p>
                          Tarjeta xy <i className="fas fa-pencil-alt"></i>
                        </p>
                      </div>
                    </div>
                    <div className="row">
          ...
          {switchV
            ? <>
            <VentaForm reloadPage={forceUpdate}></VentaForm>
            <Table>
        <ProductHeader />
        <tbody>
            ...
            <div className="mr-auto cont_productos">
              <div id="panel_busqueda">
                ...
                <FormControl className="activitie col-md-3">
                  <Select
                    native
                    inputProps={{ name: 'activitie', id: 'actividad-select' }}
