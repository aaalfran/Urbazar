          ...
          <div id="seccionForm">
            <div className="img_urbi">
              ...
              <div className="cajaLogo">
                <span className="Urbaz-partL">Urbaz</span>
                <span className="app-partL">App</span>
              </div>
            </div>
              ...
              <Container className="container_reg">
                <Card body id="tarjeta" className="trj">
                  ...
                  <div>
                    ...
                    <div id="registrate">
                      <p>
                        <a href="/recovery">He olvidado mi contraseña</a>
                      </p>
                      <p>
                        ¿No tiene una cuenta?{' '}
                        <span className="regis">
                          <a href="">Regístrese</a>
                        </span>
                      </p>
                    </div>
